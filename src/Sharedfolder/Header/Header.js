...
const Header = () => {
    ...
    return (
        <div data-theme='synthewave' className="navbar bg-base-300 fixed top-0 h-10 z-20">
            <div className="navbar-start">
                <div className="dropdown ">
                    <label tabIndex={0} className="btn btn-ghost lg:hidden">
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
                    </label>
                    <ul tabIndex={0} className="menu menu-compact dropdown-content lg:mt-3 p-2 w-80 bg-base-300">
                        <li className='flex-col items-center  w-full border m-0 p-0'>
                ...
                <Link className="text-xl hover:text-warning">Residential Hotel</Link>
            </div>
