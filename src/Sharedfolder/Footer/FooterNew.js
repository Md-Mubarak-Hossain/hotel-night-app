    ...
    <div class="flex flex-wrap md:text-left text-center order-first">
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav class="list-none mb-10">
          <li>
            <a class="hover:text-gray-800">Email</a>
          </li>
          <li>
            <a class="hover:text-gray-800">Facebook</a>
          </li>
          <li>
            <a class="hover:text-gray-800">Twitter</a>
          </li>
          <li>
      ...
      <div class="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <div class="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
            ...
            <input type="text" id="footer-field" name="footer-field" class="w-full  rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none  py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
          </div>
          <button class="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex  bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Button</button>
        </div>
  ...
  <div class="bg-base-300">
    <div class="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
      <a class="flex title-font font-medium items-center md:justify-start justify-center ">
        ...
        <span class="ml-3 text-xl">Residential Hotel</span>
      </a>
      <p class="text-sm  sm:ml-6 sm:mt-0 mt-4">© 2020 Residential Hotel —
