    ...
    return (
        <div className="card w-screen bg-base-100 shadow-xl image-full">
            ...
            <div className="card-body items-center content-center w-full">
                <h2 className='card-title text-warning font-extrabold  lg:text-5xl uppercase lg:underline decoration-wavy decoration-pink-500 lg:pb-4'>Details your <div className="w-16 lg:w-14  rounded-full"><img className="w-16 lg:w-14 rounded-full" src={picture} alt="room" /></div>{category}</h2>
